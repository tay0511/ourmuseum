...
var TpgHeading = /*#__PURE__*/function (_Component) {
  function TpgHeading() {
    var _this;
    _classCallCheck(this, TpgHeading);
    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
    _this = _callSuper(this, TpgHeading, [].concat(args));
    _defineProperty(_this, "_onChange", function (event) {
      _this.props._onChange(_this.props.name, event.target.value);
    });
    return _this;
  }
  _inherits(TpgHeading, _Component);
  return _createClass(TpgHeading, [{
    key: "render",
    value: function render() {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)("input", {
        ...
        className: "et-pb-input"
      });
    }
  }]);
}(react__WEBPACK_IMPORTED_MODULE_0__.Component);
_defineProperty(TpgHeading, "slug", 'my_custom_input');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (TpgHeading);
